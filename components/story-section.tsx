...
const faqs = [
  {
    question: "What is petite sizing?",
    answer: "Petite sizing is designed for women 5'4\" and under. Our clothing are crafted especially to fit the measurements of petite women, featuring shorter inseams, proportioned sleeves, and balanced torso lengths to fit petite frames without alterations"
  },
  {
    question: "How long do alterations typically take?",
    answer: "Standard alterations take 3-5 business days. Express service may be available for simple adjustments like hems, with same-day or next-day turnaround for an additional fee."
  },
  {
  ...
  },
  {
    ...
    answer: "We offer free returns within 30 days of purchase for unworn items with tags attached."
  },
  {
    question: "Can you alter clothing from other brands?",
    answer: "Absolutely! Our tailoring services aren't limited to our pieces. Bring in any garment and our tailors will work our magic to make it fit your petite proportions perfectly."
  },
]
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div>
            ...
            <h2 className="font-serif text-3xl md:text-4xl font-medium tracking-tight text-foreground">
              Designed by Petite Women, for Petite Women
            </h2>
