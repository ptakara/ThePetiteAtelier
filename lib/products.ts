...
export const allProducts: Product[] = [
  { id: 6, name: "Satin Grace Blouse", category: "tops", subcategory: "blouses", price: 65, image: "/images/tops/t1.png", size: ["XXS","XS","S","M",], length: ["Regular"], color: "Beige", fabric: "Satin" },
  { id: 7, name: "Azure Rib V-Neck Sweater", category: "tops", subcategory: "sweaters", price: 42, image: "/images/tops/t16.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "Blue", fabric: "Wool Blend" },
  { id: 8, name: "White Fitted Crew-Neck Tee", category: "tops", subcategory: "shirts", price: 30, image: "/images/tops/t12.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "White", fabric: "Cotton" },
  { id: 9, name: "Pink Oversized Cardigan.", category: "tops", subcategory: "cardigans", price: 42, image: "/images/tops/t7.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "Pink", fabric: "Wool Blend" },
  { id: 10, name: "Brown Crew-Neck Tee ", category: "tops", subcategory: "shirts", price: 28, image: "/images/tops/t9.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "Brown", fabric: "Cotton" },
  { id: 11, name: "Short Sleeve Kimono Blouse", category: "tops", subcategory: "blouses", price: 60, image: "/images/tops/t2.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "White", fabric: "Cotton" },
  { id: 12, name: "Classic Gold Tunic", category: "tops", subcategory: "blouses", price: 55, image: "/images/tops/t3.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "Gold", fabric: "Silk" },
  { id: 13, name: "Black Rib-Knit Cardigan", category: "tops", subcategory: "cardigans", price: 52, image: "/images/tops/t8.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "Black", fabric: "Wool Blend" },
  { id: 14, name: "Polka Dot Ruffle Trim Blouse.", category: "tops", subcategory: "blouses", price: 48, image: "/images/tops/t4.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "White", fabric: "Cotton" },
  { id: 15, name: "Textured Grey Sweater", category: "tops", subcategory: "sweaters", price: 44, image: "/images/tops/t15.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "Grey", fabric: "Wool Blend" },
  { id: 16, name: "Black Satin Cowl-Neck Tank .", category: "tops", subcategory: "blouses", price: 48, image: "/images/tops/t5.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "Black", fabric: "Satin" },
  { id: 17, name: "White Polished Tank Top.", category: "tops", subcategory: "blouses", price: 70, image: "/images/tops/t6.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "White", fabric: "Cotton" },
  { id: 18, name: "White Clean Vest", category: "tops", subcategory: "blouses", price: 40, image: "/images/tops/t18.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "White", fabric: "Cotton" },
  { id: 19, name: "Flowerly Boatneck Blouse", category: "tops", subcategory: "blouses", price: 55, image: "/images/tops/t10.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "White", fabric: "Cotton" },
  { id: 20, name: "Deep Blue V-Cardigan", category: "tops", subcategory: "cardigans", price: 50, image: "/images/tops/t13.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "Blue", fabric: "Wool Blend" },
  { id: 21, name: "Ivory Stripe Sweater ", category: "tops", subcategory: "sweaters", price: 32, image: "/images/tops/t14.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "White", fabric: "Wool Blend" },
  { id: 22, name: "Nordic Yoke Cardigan", category: "tops", subcategory: "cardigans", price: 56, image: "/images/tops/t17.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "blue", fabric: "Wool Blend" },
  { id: 23, name: "Charcoal Collar Vest", category: "tops", subcategory: "blouses", price: 45, image: "/images/tops/t19.png", size: ["XXS","XS","S","M"], length: ["Regular"], color: "Black", fabric: "Cotton" },
